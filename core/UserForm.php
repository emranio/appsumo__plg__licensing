...
class UserForm
{
    ...
    {
        add_action('appsumo__gutenkit__footer_userform', [$this, 'render_the_form']);
    ...
    private function save_the_form()
    {
        ...
        if (empty(isset($_POST['appsumo__gutenkit__save_userform_nonce']))) {
            return;
        }
        if (!wp_verify_nonce($_POST['appsumo__gutenkit__save_userform_nonce'], 'appsumo__gutenkit__save_userform')) {
            return;
        }

        $firstname = sanitize_text_field($_POST['appsumo__gutenkit__firstname']);
        $lastname = sanitize_text_field($_POST['appsumo__gutenkit__lastname']);
    ...
    public function render_the_form()
    {
        ...
        if ($is_appsumo__gutenkit__user !== 'yes') {
            return;
        }
        ...
        $already_logged_in = get_user_meta($user->ID, 'appsumo__gutenkit__already_logged_in', true);
